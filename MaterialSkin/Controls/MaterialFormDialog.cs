...
namespace MaterialSkin.Controls
{
    public class MaterialFormDialog : Form, IMaterialControl
    {
        ...
        private const int STATUS_BAR_HEIGHT = 0;
        ...
        private const int BORDER_WEIGHT = 2;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var borderPen = new Pen(backColor, BORDER_WEIGHT))
            {
                ...
                if (string.IsNullOrEmpty(Text))
                    topBorder = 0;
                //LEFT
                g.DrawLine(borderPen, new Point(BORDER_WEIGHT-1, topBorder), new Point(BORDER_WEIGHT-1, Height));
                //RIGHT
                g.DrawLine(borderPen, new Point(Width - (BORDER_WEIGHT - 1), topBorder), new Point(Width - (BORDER_WEIGHT - 1), Height));
                //BOTTOM
                g.DrawLine(borderPen, new Point(BORDER_WEIGHT, Height - (BORDER_WEIGHT - 1)), new Point(Width - BORDER_WEIGHT, Height - (BORDER_WEIGHT - 1)));
                //TOP
                if (topBorder == 0)
                   g.DrawLine(borderPen, new Point(BORDER_WEIGHT, (BORDER_WEIGHT - 1)), new Point(Width - BORDER_WEIGHT, (BORDER_WEIGHT - 1)));
            }
